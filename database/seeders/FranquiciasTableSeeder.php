    ...
    public function run(): void
    {
        ...
        $franquicias = [
            [
                ...
                'imagen' => 'https://alpalodevs.net/storage/franquicias/the_legend_of_zelda.jpg',
                'logo' => 'https://alpalodevs.net/storage/franquicias/logos/the_legend_of_zelda_logo.png',
            ],
            [
                'nombre' => 'Super Mario',
                ...
                'imagen' => 'https://alpalodevs.net/storage/franquicias/super_mario.jpg',
                'logo' => 'https://alpalodevs.net/storage/franquicias/logos/super_mario_logo.png',
            ],
            [
                ...
                'imagen' => 'https://alpalodevs.net/storage/franquicias/metal_gear.jpg',
                'logo' => 'https://alpalodevs.net/storage/franquicias/logos/metal_gear_solid_logo.png',
            ],
            [
                'nombre' => 'Donkey Kong',
                ...
                'imagen' => 'https://alpalodevs.net/storage/franquicias/donkey_kong.jpg',
                'logo' => 'https://alpalodevs.net/storage/franquicias/logos/donkey_kong_logo.png',
            ],
            [
                'nombre' => 'Persona',
                ...
                'imagen' => 'https://alpalodevs.net/storage/franquicias/persona.jpg',
                'logo' => 'https://alpalodevs.net/storage/franquicias/logos/persona_logo.png',
            ],
            [
                'nombre' => 'Doom',
                ...
                'imagen' => 'https://alpalodevs.net/storage/franquicias/doom.jpg',
                'logo' => 'https://alpalodevs.net/storage/franquicias/logos/doom_logo.png',
            ],
            [
                'nombre' => 'Portal',
                ...
                'imagen' => 'https://alpalodevs.net/storage/franquicias/portal.jpg',
                'logo' => 'https://alpalodevs.net/storage/franquicias/logos/portal_logo.png',
            ],
            [
                ...
                'imagen' => 'https://alpalodevs.net/storage/franquicias/super_smash_bros.jpg',
                'logo' => 'https://alpalodevs.net/storage/franquicias/logos/super_smash_bros_logo.png',
            ],
            [
                ...
                'imagen' => 'https://alpalodevs.net/storage/franquicias/red_dead_redemption.jpg',
                'logo' => 'https://alpalodevs.net/storage/franquicias/logos/red_dead_redemption_logo.png',
            ],
        ];
